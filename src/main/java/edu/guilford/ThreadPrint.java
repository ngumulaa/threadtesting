...
// The Runnable interface allows us to instantiate thread objetcs 
public class ThreadPrint implements Runnable{
    // add some attrubutes to keep track of this thread 
    private String name; 
    private Random rand = new Random();
    // each threat will sleep between 1 and 6 seconds 
